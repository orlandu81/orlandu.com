...
const GALLERY = [
  ...
  { type: "image", src: "media/2026/dk-portrait.jpg", title: "Donkey Kong", caption: "Blue plywood &mdash; marquee lit in the garage row", cat: "arcade" },
  { type: "image", src: "media/2026/unisystem-screen.jpg", title: "VS. Super Mario Bros.", caption: "The dedicated UniSystem in attract mode &mdash; the arcade version, which is not the one you remember", cat: "arcade" },
  { type: "image", src: "media/2026/ij-playfield.jpg", title: "Indiana Jones, all lit", caption: "Widebody playfield &mdash; mine cart right, idol center, and Williams using every inch", cat: "pinball" },
  { type: "image", src: "media/2026/tna-playfield.jpg", title: "Reactor lit", caption: "Total Nuclear Annihilation mid-game &mdash; the tempo climbs with every reactor you clear", cat: "pinball" },
  { type: "image", src: "media/2026/ghostbusters-playfield.jpg", title: "Ghostbusters Premium", caption: "Zombie Yeti artwork lit like a nightclub, magna-slings waiting", cat: "pinball" },
  { type: "image", src: "media/2026/lmd-rack.jpg", title: "The LMD squadron", caption: "Three of the LMD fleet running side by side, all set to zero scan", cat: "monitors" },
  { type: "video", src: "media/video/game-room-spin-v2.mp4", poster: "media/2026/game-room-spin-poster.jpg", title: "The game room, one full turn", caption: "A slow spin around the inside room \u2014 the framed PCB wall, Super Mario Bros. on the PVMs, the Mega CD library under the Kay\u00b7Bee World of Nintendo sign, and the Red Tent holding the corner", cat: "consoles" },
  ...
  { type: "image", src: "media/2026/donkey-kong-tkg4.jpg", title: "Donkey Kong", caption: "Blue plywood — marquee lit, 130,300 on the board", cat: "arcade", date: "2026-08" },
  ...
  { type: "image", src: "media/2026/big-blue-portrait.jpg", title: "Big Blue, suited up", caption: "Fresh Capcom side art on the Dynamo Gen 1, Marvel vs. Capcom up on the tube — the rebuild that started with the power supply, finished", cat: "arcade", date: "2026-08" },
  ...
  { type: "image", src: "media/2026/ams-100-lineup.jpg", title: "The AMS-100 lineup", caption: "Sony's rack-width audio monitor speakers, mustered for inspection", cat: "monitors", date: "2026-08" },
  { type: "image", src: "media/2026/game-room.jpg", title: "The game room", caption: "Framed PCB wall, the console shelf, Super Mario Bros. on the PVMs, and the chair every arcade needs", cat: "consoles", date: "2026-08" },
];
