...
const GALLERY = [
  ...
  { type: "image", src: "media/2026/sign-racetrack-glow.jpg", title: "The racetrack", caption: "NESM36F fiber optic \u2014 white letters inside the red oval that gives the sign its name", cat: "signage" },
  ...
  { type: "image", src: "media/2026/dk-portrait.jpg?v=2", title: "Donkey Kong", caption: "Blue plywood &mdash; marquee lit in the garage row", cat: "arcade" },
  { type: "image", src: "media/2026/unisystem-screen.jpg?v=2", title: "VS. Super Mario Bros.", caption: "The dedicated UniSystem in attract mode &mdash; the arcade version, which is not the one you remember", cat: "arcade" },
  { type: "image", src: "media/2026/ij-playfield.jpg?v=2", title: "Indiana Jones, all lit", caption: "Widebody playfield &mdash; mine cart right, idol center, and Williams using every inch", cat: "pinball" },
  { type: "image", src: "media/2026/tna-playfield.jpg?v=2", title: "Reactor lit", caption: "Total Nuclear Annihilation mid-game &mdash; the tempo climbs with every reactor you clear", cat: "pinball" },
  { type: "image", src: "media/2026/ghostbusters-playfield.jpg?v=2", title: "Ghostbusters Premium", caption: "Zombie Yeti artwork lit like a nightclub, magna-slings waiting", cat: "pinball" },
  { type: "image", src: "media/2026/lmd-rack.jpg?v=2", title: "The LMD squadron", caption: "Three of the LMD fleet running side by side, all set to zero scan", cat: "monitors" },
  ...
  { type: "image", src: "media/2026/big-blue-portrait.jpg?v=2", title: "Big Blue, suited up", caption: "Marvel vs. Capcom on the marquee and on the tube, CAPCOM badge on the panel — the rebuild that started with the power supply, finished. <a href='big-blue.html'>The full profile →</a>", cat: "arcade", date: "2026-08" },
